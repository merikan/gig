...
This assignment is governed by Swedish law. Under Swedish copyright law (Upphovsrättslagen §3), moral rights (*ideell rätt*) can't be fully waived - only for a use limited in nature and scope - so moral rights aren't transferred, only waived to that limited extent.
...
> This clause is a template, not reviewed by a lawyer, and relies on contributing as your agreement - that may not satisfy formal signature requirements for a binding transfer in every jurisdiction. Treat it as a clear statement of intent, not a guaranteed enforceable transfer, until it's had legal review.
